...
def apriori_improved(data, min_support=0.1, min_confidence=0.5):
    """
    Perform optimized Apriori algorithm for frequent itemset mining.
    """
